...
<Profile xmlns="http://soap.sforce.com/2006/04/metadata">
    <classAccesses>
        <apexClass>RecordCtrl</apexClass>
    ...
    <fieldPermissions>
        <editable>true</editable>
        <field>DataCenter__c.Location__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>DataCenter__c.Server_Number__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
    ...
    <fieldPermissions>
        <editable>true</editable>
        <field>Server_Map_Record__c.DataCenter__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>Server_Map_Record__c.Server__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>Server__c.Power_Down__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>Server__c.Power_LeveL__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>Server__c.Server_ID__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
    ...
    <layoutAssignments>
        <layout>DataCenter__c-DataCenter Layout</layout>
    </layoutAssignments>
    <layoutAssignments>
    ...
    <layoutAssignments>
        <layout>Server_Map_Record__c-Server Map Record Layout</layout>
    </layoutAssignments>
    <layoutAssignments>
        <layout>Server__c-Sever Layout</layout>
    </layoutAssignments>
    <layoutAssignments>
    ...
    <objectPermissions>
        ...
        <allowRead>true</allowRead>
        <modifyAllRecords>true</modifyAllRecords>
        <object>Server_Map_Record__c</object>
        <viewAllRecords>true</viewAllRecords>
    </objectPermissions>
    <objectPermissions>
        <allowCreate>true</allowCreate>
    ...
    <pageAccesses>
        <apexPage>NewRecordPage</apexPage>
        <enabled>true</enabled>
    </pageAccesses>
    <pageAccesses>
        <apexPage>RecordViewPage</apexPage>
        <enabled>true</enabled>
    </pageAccesses>
